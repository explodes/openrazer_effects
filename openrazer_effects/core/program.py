...
from client.devices.keyboard import RazerKeyboard
from client.fx import Frame
from openrazer_effects.core.utils import FpsLimiter, find_keyboard, MAX_FPS


class KeyboardProgram(object):
